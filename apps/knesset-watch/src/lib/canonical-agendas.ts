 ...
 * ── למה ירד מ-5 ל-1 ──────────────────────────────────────────────────
 *
 * הנימוק המקורי היה "הציר נשען על מעט מדי חוקים מכדי לדרג בו", וזה
 * נכון. אבל הסף פותר את זה בהסתרה, ומנגנון הביטחון שכבר קיים פותר
 * את אותו דבר בגילוי נאות. נמדד:
 *
 *    5 הצעות  →  ביטחון 18%, 12%, 12%
 *    8 הצעות  →  ביטחון  6%
 *  243 הצעות  →  ביטחון 94%, 94%, 93%
 *
 * כלומר ציר קטן כבר מציג לצד הציון את אי-הוודאות שלו. באתר שקיפות,
 * להראות תוצאה חלשה ולסמן אותה ככזו עדיף על להסתיר אותה.
 *
 * הסף לא בוטל לגמרי: ציר בלי אף הצעה אינו מדרג איש ואין טעם להציג
 * אותו. 1 הוא המינימום שמשאיר משמעות.
 *
 * ── מה זה לא משנה ────────────────────────────────────────────────────
 *
 * אף הצעת חוק אינה מסווגת מחדש, ואף ציון של ציר קיים אינו זז. כל
 * השימושים ב-POLITICAL_ISSUES הם חיפוש לפי מזהה, ולכן ההשפעה אדיטיבית
 * בלבד: צירים שהיו מוסתרים הופכים לנגישים.
 */
export const MIN_BILLS_PER_ISSUE = 1;
