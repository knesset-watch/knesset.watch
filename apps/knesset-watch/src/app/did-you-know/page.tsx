...
const ENTRIES = [
  ...
  { id: 'count',      q: 'למה כתוב 123 חברי כנסת, אם בכנסת 120 מושבים?' },
    ...
    <div className="mx-auto max-w-3xl px-6 py-12" dir="rtl">
      ...
      <div className="flex flex-col gap-12">
        ...
        <section id="count">
          ...
          <p className="text-body font-content text-ink-2">
            בכנסת 120 מושבים, אבל במאגר שלנו מסומנים 123 אנשים כחברי הכנסת
            ה-25. זו אינה טעות: המספר סופר את מי שהיה חבר בכנסת הזאת אי פעם
            במהלך הקדנציה, ולא את מי שיושב בה באותו רגע.
          </p>

          <Figures items={[
            { value: '120', label: 'כיהנו מתחילת הקדנציה' },
            { value: '3',   label: 'נכנסו במהלך 2026' },
            { value: '0',   label: 'הצבעות רשומות לשלושת הנכנסים' },
          ]} />

          <p className="text-body font-content text-ink-2">
            ח״כ שפורש, מתפטר או נפטר מפנה את מקומו לבא אחריו ברשימת מפלגתו.
            יש גם החוק הנורבגי, שמאפשר לשר להתפטר מהכנסת כדי שחבר נוסף מרשימתו
            ייכנס במקומו — ולחזור אם יסיים את תפקידו בממשלה. לאורך קדנציה שלמה
            מספר האנשים שעברו דרך 120 המושבים גדול מ-120.
          </p>

          <p className="text-ui text-mute">
            שלושת הנכנסים במאגר הצטרפו ביוני, ביולי ובאוגוסט 2026, ולאף אחד מהם
            אין עדיין הצבעה רשומה. זו הסיבה שהם לא יופיעו בתוצאות השאלון: הדירוג
            נשען על הצעות חוק והצבעות, ומי שטרם הספיק להצביע אין לו מה להימדד בו.
            זהו מקרה פרטי של אותו עיקרון שמוסבר למעלה —{' '}
            <a href="#missing" className="text-accent underline">
              היעדרות מהתוצאות אינה עדות לחוסר עשייה
            </a>.
          </p>

          <p className="text-ui text-mute">
            מה שהמאגר עדיין אינו יודע הוא מי פרש ומתי, ולכן אי אפשר לומר מתוכו
            מי מכהן ברגע זה — רק מי היה חבר בכנסת הזאת. בכל מקום שבו מוצג המספר
            הזה כתוב ״בכנסת ה-25״ ולא ״מכהנים כעת״, כי רק הראשון נכון.
          </p>
        </section>

        <section id="garbled">
          <h2 className="text-section mb-3">{ENTRIES[9].q}</h2>
          <p className="text-body font-content text-ink-2">
