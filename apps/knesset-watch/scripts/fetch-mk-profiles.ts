...
const MANUAL_QID: Record<number, string> = {
  ...
  // נכנסו לכנסת ב-2026. הפריט קיים ב-Wikidata אך חסר לו P39 תחת
  // הכנסת ה-25, ולכן השאילתה לפי כהונה מפספסת אותם. המזהים אותרו
  // דרך pageprops בוויקיפדיה העברית.
  30916: 'Q140142401', // עוז חיים
  30917: 'Q140774391', // מוחמד אבו אל-היג'א
};
